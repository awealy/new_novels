...
class NovelApp {
    ...
    async loadNovels() {
        try {
            const response = await fetch('novels.json');  // 确保这个路径正确
    ...
    getSampleData() {
        return [
            ...
            },
            {
                ...
                "title": "漫漫消沉",
                "author": "爱装的wy",
                "description": "这是新人的第一个作品，可以支持一下吗？...",
                "tags": ["都市", "双男", "青春", "甜宠", "爽文"],
                "cover": "🎮",
                "path": "novels/cxy",
                "chapters": [
    ...
    async showNovelDetail(novelId) {
        ...
        try {
            ...
            modalContent.innerHTML = `
                ...
                <button onclick="window.location.href='reader.html?novel=${novel.id}&chapter=1'" class="read-btn">开始阅读</button>
            `;
